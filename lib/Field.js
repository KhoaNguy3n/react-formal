...
var Field = function (_React$Component) {
  ...
  function Field() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this.bindTo = function (_value, getter) {
      ...
      var _this$props2 = _this.props,
          ...
          _this$props2$events = _this$props2.events,
          events = _this$props2$events === undefined ? _config2.default.events : _this$props2$events,
          _this$props2$errorCla = _this$props2.errorClass,
          errorClass = _this$props2$errorCla === undefined ? _config2.default.errorClass : _this$props2$errorCla;


      var fieldProps = (0, _chainEvents2.default)(events, [{ name: name }, { children: children }, (0, _omit2.default)(_this.props, Object.keys(Field.propTypes)), bindingProps, triggerProps]);
      ...
      var _resolveFieldComponen = (0, _resolveFieldComponent2.default)(type, _this.schema(name)),
          Component = _resolveFieldComponen[0],
          resolvedType = _resolveFieldComponen[1];
  ...
  Field.prototype.render = function render() {
    ...
    var _props = this.props,
        ...
        mapFromValue = _props.mapFromValue,
        alsoValidates = _props.alsoValidates,
        _props$events = _props.events,
        events = _props$events === undefined ? _config2.default.events : _props$events;
